...
![Lost my keys - Screenshot](./image.png)

Running binwalk to extract files:

![Lost my keys - Screenshot](./image_2.png)
...
rgb values on the top left seems to have difference of 1:

![Lost my keys - Screenshot](./image_3.png)
...
get the binary and throw it into bin to string u get the flag:

![Lost my keys - Screenshot](./image_4.png)
